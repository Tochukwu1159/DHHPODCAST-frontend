...
export const PodcastCard = ({ podcast, user, setSignInOpen, refresher }) => {
  
  
  // const [favourite, setFavourite] = useState(podcast.isFavorite);
...
const {mutate: addToView, isPending: viewPending} = useCreatePodcastView(favouriteId) 
  ...
  const handleClick = (id) => {
    console.log("identity hereee", id)
      setFavouriteId(id)
        addToFavorite();
    ...
    <Card to={`/podcast/${podcast.id}`} >
      <div >
        ...
        <Top>
          ...
          <CardImage src={podcast?.coverPhoto}/>
        </Top>
        <CardInformation>
          <MainInfo>
