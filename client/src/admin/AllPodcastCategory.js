...
export const AllPodcastCategory = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        muiEditTextFieldProps: {
          required: true,
          error: !!validationErrors?.subscriptionPlan,
          helperText: validationErrors?.subscriptionPlan,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
      ...
      },
      {
        ...
        header: 'Cover Photo',
        Cell: ({ cell }) => (
          <img src={cell.getValue()} alt="Cover" style={{ width: '100px', height: 'auto' }} />
        ),
        muiEditTextFieldProps: {
          required: true,
