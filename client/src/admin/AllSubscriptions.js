...
import { useGetAllSubscription } from '../api/SubscriptionPlan'; 

export const AllSubscriptionPlan = () => {

  const {data: plan} = useGetAllSubscription();
...
//     useDeleteUser();
  ...
  const all_Subscriptions = allSubscription[0]?.data;
